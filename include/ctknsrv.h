#ifndef CTKNSRV_H_INCLUDED_
#define CTKNSRV_H_INCLUDED_ 1
/**
...
#define CTKNSRV_FUNCTION_ARGS void* buffer, long long length, long long tag, zsys_ddl_recvinformation2_def* info
